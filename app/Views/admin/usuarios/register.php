...
<div class="container">
    ...
    <form action="<?= base_url('storeRegister'); ?>" method="post">
        <?= csrf_field() ?>


        <input type="hidden" name="role" value="externo">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text"
                       class="form-control <?= session('validation') && session('validation')->hasError('matricula') ? 'is-invalid' : '' ?>"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text"
                       class="form-control <?= session('validation') && session('validation')->hasError('nombre') ? 'is-invalid' : '' ?>"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text"
                       class="form-control <?= session('validation') && session('validation')->hasError('apaterno') ? 'is-invalid' : '' ?>"
                       id="apaterno" name="apaterno" value="<?= old('apaterno'); ?>">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text"
                       class="form-control <?= session('validation') && session('validation')->hasError('amaterno') ? 'is-invalid' : '' ?>"
                       id="amaterno" name="amaterno" value="<?= old('amaterno'); ?>">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text"
                       class="form-control <?= session('validation') && session('validation')->hasError('telefono') ? 'is-invalid' : '' ?>"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text"
                       ...
                       id="username" name="username" value="<?= old('username'); ?>" oninput="removeSpaces(this)">
            ...
            <input type="hidden" name="is_prfole_complete" value="false">
...
<script>
    ...
    document.getElementById('apaterno').addEventListener('input', generateUsername);
    document.getElementById('amaterno').addEventListener('input', generateUsername);
    ...
    function generateUsername() {
        ...
        const suggestedUsername = (nombre + apaterno).toLowerCase().replace(/\s+/g, '');
